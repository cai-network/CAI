...
struct SettingsView: View {
            ...
            Section("Models Directories") {
                LabeledContent("Default Models Directory") {
                    TextField(
                        ...
                        prompt: Text("~/.CAI/models")
                    )
                    .textFieldStyle(.roundedBorder)
                    .font(.system(.body, design: .monospaced))
                    .frame(width: 260)
                }
                Text("Sets CAI_DEFAULT_MODELS_DIR. Where models are downloaded.")
                    .font(.caption)
                    .foregroundColor(.secondary)
                ...
                Text("Sets CAI_MODELS_DIRS. Extra writable model directories.")
                    .font(.caption)
                    .foregroundColor(.secondary)
                ...
                Text("Sets CAI_MODELS_READ_ONLY_DIRS. Never written to.")
                    .font(.caption)
                    .foregroundColor(.secondary)
            }
    ...
    private func applyEnvironmentSettings() {
        ...
        // CAIProcessController.makeEnvironment and avoids silently losing

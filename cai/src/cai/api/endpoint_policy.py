...
CAI_ENDPOINT_POLICIES: tuple[EndpointPolicy, ...] = (
    ...
    EndpointPolicy("GET", "/v1/cai/update/status", EndpointAccess.LOCAL_ONLY, "Local user update state."),
    EndpointPolicy("POST", "/v1/cai/update/check", EndpointAccess.LOCAL_ONLY, "Local user-triggered update check."),
    EndpointPolicy("POST", "/v1/cai/update/apply", EndpointAccess.LOCAL_ONLY, "Local user-triggered update apply."),

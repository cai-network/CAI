...
``cai.shared.types.text_generation.TextGenerationTaskParams``.
"""
...
class ResponsesRequest(BaseModel, frozen=True):
    ...
    # --- cai extensions (not in OpenAI Responses API spec) ---
    enable_thinking: bool | None = Field(
        default=None,
        description="[cai extension] Boolean thinking toggle. Not part of the OpenAI Responses API.",
        json_schema_extra={"x-CAI-extension": True},
    )

    top_k: int | None = Field(
        default=None,
        description="[cai extension] Top-k sampling parameter. Not part of the OpenAI Responses API.",
        json_schema_extra={"x-CAI-extension": True},
    )
    stop: str | list[str] | None = Field(
        default=None,
        description="[cai extension] Stop sequence(s). Not part of the OpenAI Responses API.",
        json_schema_extra={"x-CAI-extension": True},
    )
    seed: int | None = Field(
        default=None,
        description="[cai extension] Seed for deterministic sampling. Not part of the OpenAI Responses API.",
        json_schema_extra={"x-CAI-extension": True},
    )
    ...
    chat_template_messages: list[dict[str, Any]] | None = Field(
        ...
        json_schema_extra={"x-CAI-internal": True},
    )

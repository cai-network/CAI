...
from cai.shared.constants import CAI_DEFAULT_MODELS_DIR, CAI_MODELS_READ_ONLY_DIRS
from cai.shared.models.model_cards import ModelId, get_model_cards
...
class DownloadCoordinator:
    ...
    def _default_model_dir(model_id: ModelId) -> str:
        return str(CAI_DEFAULT_MODELS_DIR / model_id.normalize())

...
from cai.shared.constants import CAI_MAX_CHUNK_SIZE, CAI_TRACING_ENABLED
from cai.shared.models.model_cards import ModelTask
from cai.shared.tracing import clear_trace_buffer, get_trace_buffer
from cai.shared.types.chunks import ErrorChunk, ImageChunk
...
from cai.worker.engines.image import (
...
def _send_image_chunk(
    ...
    data_chunks = [
        encoded_data[i : i + CAI_MAX_CHUNK_SIZE]
        for i in range(0, len(encoded_data), CAI_MAX_CHUNK_SIZE)
    ]

...
from cai.shared.constants import CAI_DEFAULT_MODELS_DIR
...
from cai.shared.types.text_generation import InputMessage, TextGenerationTaskParams

MODEL_ID = "mlx-community/gpt-oss-20b-MXFP4-Q8"
MODEL_PATH = CAI_DEFAULT_MODELS_DIR / "mlx-community--gpt-oss-20b-MXFP4-Q8"
TOTAL_LAYERS = 24
MAX_TOKENS = 10
SEED = 42
TEMPERATURE = 0.0
...
def _build_prompt(tokenizer: Any, prompt_tokens: int) -> tuple[str, Any]:
    ...
    from cai.worker.engines.mlx.utils_mlx import apply_chat_template
...
def _run_single_device(
    ...
    try:
        ...
        from cai.worker.engines.mlx.cache import encode_prompt
        from cai.worker.engines.mlx.generator.generate import mlx_generate
...
def _run_pipeline_device(
    ...
    try:
        ...
        from cai.worker.engines.mlx.cache import encode_prompt
        from cai.worker.engines.mlx.generator.generate import mlx_generate
        from cai.worker.engines.mlx.utils_mlx import shard_and_load
        ...
        def distributed_prompt_progress_callback(_group: Any = group) -> None:
            from cai.worker.engines.mlx.utils_mlx import mx_any

...
from cai.api.types import CompletionTokensDetails, PromptTokensDetails, Usage
...
from cai.worker.runner.llm_inference.model_output_parsers import (
    count_reasoning_tokens,
    parse_deepseek_v32,
    parse_thinking_models,
    parse_tool_calls,
)
from cai.worker.runner.llm_inference.tool_parsers import make_mlx_parser
...
class TestBatchGeneratorSingleNext:
    def test_finish_reason_with_buffered_tokens_drain_loop(self):
        from cai.worker.runner.llm_inference.batch_generator import GeneratorQueue

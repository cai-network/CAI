...
import cai.worker.runner.llm_inference.batch_generator as mlx_batch_generator
import cai.worker.runner.llm_inference.model_output_parsers as mlx_model_output_parsers
import cai.worker.runner.llm_inference.runner as mlx_runner
...
from cai.shared.types.worker.runner_response import GenerationResponse
...
from cai.utils.channels import mp_channel
...
def patch_out_mlx(monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr(mlx_batch_generator, "CAIBatchGenerator", FakeCaiBatchGenerator)


class FakeCaiBatchGenerator:
...
def _run(tasks: Iterable[Task], send_after_ready: list[Task] | None = None):
    ...
    with task_sender:
        ...
        with unittest.mock.patch(
            "cai.worker.runner.llm_inference.runner.mx.distributed.all_gather",

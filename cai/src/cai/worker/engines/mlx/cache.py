...
from cai.worker.engines.mlx.constants import CACHE_GROUP_SIZE, KV_CACHE_BITS
from cai.worker.runner.bootstrap import logger

if TYPE_CHECKING:
    from cai.worker.engines.mlx.vision import MediaRegion
...
_MEMORY_THRESHOLD = float(
    os.environ.get("CAI_MEMORY_THRESHOLD", _default_memory_threshold())
)

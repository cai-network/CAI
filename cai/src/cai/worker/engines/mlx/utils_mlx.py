...
from cai.worker.engines.mlx.constants import TRUST_REMOTE_CODE
...
from cai.download.download_utils import build_model_path
from cai.shared.types.common import Host
from cai.shared.types.memory import Memory
from cai.shared.types.mlx import Model
from cai.shared.types.tasks import TaskId, TextGeneration
from cai.shared.types.text_generation import ChatTemplateValue, TextGenerationTaskParams
...
def render_chat_template(
    ...
    if _needs_dsml_encoding(task_params):
        from cai.worker.engines.mlx.dsml_encoding import encode_messages

...
from cai.shared.types.worker.shards import CfgShardMetadata, PipelineShardMetadata
from cai.worker.engines.image.config import ImageModelConfig
from cai.worker.engines.image.models import (
    create_adapter_for_model,
    get_config_for_model,
)
from cai.worker.engines.image.models.base import ModelAdapter
from cai.worker.engines.image.pipeline import DiffusionRunner
from cai.worker.engines.mlx.utils_mlx import mlx_distributed_init, mx_barrier

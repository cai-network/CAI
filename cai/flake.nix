...
{
  description = "The development environment for cai";
  ...
  nixConfig = {
    extra-trusted-public-keys = "cai.cachix.org-1:okq7hl624TBeAR3kV+g39dUFSiaZgLRkLsFBCuJ2NZI=";
    extra-substituters = "https://cai.cachix.org";
  };
      ...
      perSystem = { config, self', pkgs, lib, system, ... }:
        {
          ...
          treefmt = {
            ...
            programs = {
              ...
              ruff-format = {
                enable = true;
                excludes = [ "rust/cai_pyo3_bindings/cai_pyo3_bindings.pyi" ];
              };
              rustfmt = {
                enable = true;

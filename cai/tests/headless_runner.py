...
from cai.shared.types.commands import CommandId
...
from cai.worker.runner.bootstrap import entrypoint
...
def list_models():
    sent = set[str]()
    for path in CAI_DEFAULT_MODELS_DIR.rglob("model-*.safetensors"):

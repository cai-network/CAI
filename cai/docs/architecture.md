...
-->
# cai Architecture overview

cai uses an _Event Sourcing_ architecture, and Erlang-style _message passing_. To facilitate this, we've written a channel library extending anyio channels with inspiration from tokio::sync::mpsc. 
...
Adapters convert between external API formats and cai's internal types:

...
8. We want people to be able to copy models over to a new device without ever connecting cai to the internet. Right now cai require internet connection once to cache some files to check if a download is complete. Instead, we should simply check if there is a non-empty model folder locally with no .partial files. This indicates it's a fully downloaded model that can be loaded.
13. Memory pressure instead of memory used.
14. Show the type of each connection (TB5, Ethernet, etc.) in the UI. Refer to old cai: https://github.com/CAI-explore/CAI/blob/56f783b38dc6b08ce606b07a5386dc40dae00330/CAI/helpers.py#L251
15. Prioritise certain connection types (or by latency). TB5 > Ethernet > WiFi. Refer to old cai: https://github.com/CAI-explore/CAI/blob/56f783b38dc6b08ce606b07a5386dc40dae00330/CAI/helpers.py#L251

...
{ inputs, ... }:
{
  perSystem =
    ...
    in
    {
      ...
      packages.dashboard = pkgs.runCommand "cai-dashboard" { } ''
      ...
      packages.prettier-svelte = pkgs.writeShellScriptBin "prettier-svelte" ''
        export NODE_PATH="${dashboardDeps}/lib/node_modules/cai-dashboard/node_modules"
        exec ${pkgs.nodejs}/bin/node \
          ${dashboardDeps}/lib/node_modules/cai-dashboard/node_modules/prettier/bin/prettier.cjs \
          --plugin "${dashboardDeps}/lib/node_modules/cai-dashboard/node_modules/prettier-plugin-svelte/plugin.js" \
          "$@"
      '';
    };
}

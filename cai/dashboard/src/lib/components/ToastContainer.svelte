...
{#if items.length > 0}
  ...
  >
    {#each items as toast (toast.id)}
      ...
      <div
        class="pointer-events-auto max-w-sm w-80 bg-cai-dark-gray/95 backdrop-blur-sm border border-cai-medium-gray/60 border-l-[3px] {style.border} rounded shadow-lg shadow-black/40"

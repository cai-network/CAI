...
{#if src}
  ...
  >
    <div class="absolute top-4 right-4 flex gap-2 z-10">
      <button
        type="button"
        class="p-2 rounded-lg bg-cai-dark-gray/80 border border-cai-yellow/30 text-cai-yellow hover:bg-cai-dark-gray hover:border-cai-yellow/50 cursor-pointer transition-colors"
